...
A compact macOS menu bar player for NTS Radio inspired by the [Atonemo NTS Radio Player]((https://shop.nts.live/products/atonemo-nts-radio-player)). Tune into NTS 1, NTS 2, or the Infinite Mixtapes from a tactile SwiftUI dial.
...
- Download NTS.Dial.app.zip in the releases page.
- Unzip the file.
